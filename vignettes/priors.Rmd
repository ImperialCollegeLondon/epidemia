...
The scale of the `prior` argument may be adjusted internally to ensure that the prior 
is weakly informative. This can happen both when the default argument is used, and when 
...
If an adjustment has been made, this will show both the originally specified prior and the scaled version.
