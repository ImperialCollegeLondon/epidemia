...
a numeric simplex vector that gives the same delay distribuion as used in 
@Flaxman2020. 

Additional arguments include `family`, which specifies the sampling distribution 
$p(y_t, \phi)$. There are additional arguments which allow the user to control 
prior distributions for paramters describing $\alpha$, and the prior on the 
