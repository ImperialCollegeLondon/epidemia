...
@Flaxman2020, which is a discretized p.d.f. of a mixture of Gamma random variables.
...
description <- c(
    ...
    "response that is being modeled (i.e. the actual observations, not the latent ascertainment rates)",
