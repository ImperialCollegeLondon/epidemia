...
df <- data.frame(Arguments = c("formula", 
                 ...
                 Description = c("An R object of class 'formula'. The left hand side must take the form `R(group,date)`, with `group` representing a factor vector giving the group membership (i.e. country, state, age cohort). `date` must ve a vector of Date objects.",
                                 "Provides the data used in the model specified by 'formula'.",
                                 "A list providing all observed data.",
                                 "Population size for each group.",
                                 "The serial interval of the disease.",
                                 "Number of days for which to seed infections",
                                 "The algorithm used to fit the model.",
                                 "(Optional) ",
                                 "Flag whether to center covariates.",
                                 "Prior on $\\beta$, excluding the intercept.",
                                 "Prior on the intercept, if it exists in the model.",
                                 "Prior on the covariance matrix of $b$, the group-specific paramters.",
                                 ...
                                 "Arguments to pass to the sampling algorithm."),
                 type = c("Formula",
                          "data.frame",
                          "list",
                          "data.frame",
