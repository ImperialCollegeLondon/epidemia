...
\ref{computeItaly} considers fitting a model to the Italian data, and demonstrates usage of various arguments to `epim`.
...
df <- data.frame(Arguments = c("formula", 
                               ...
                               "prior_PD",
                               "sampling_args"),
                 Description = c("An R object of class 'formula'",
