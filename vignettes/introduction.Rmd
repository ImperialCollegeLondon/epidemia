...
The parameters $\beta$ are assigned a prior distribution. This is flexible, and leverages the framework offered by **rstanarm**. Multiple different prior families are available. The group specific coefficients $b$ are treated as zero mean multivariate normal. Prior specifications are described in more detail in Section \@ref(prior-arguments).
