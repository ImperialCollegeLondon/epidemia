...
The package contains the dataset used in the Nature paper. Load weith
...
`EuropeCovid` is a list containing most of the information required for `epim`. These fields are names as follows.
