...
# Effects of Interventions on Covid-19 <img src='figures/logo.png' class = "small_logo" align="right"/>
<hr>
...
considered a version of this model that partial pooling for all the effects of NPIs. 
...
ggsave("figures/multilevel-prior-plot.png", width=5, height=5)
knitr::include_graphics("figures/multilevel-prior-plot.png")
```
...
ggsave("figures/multilevel-obs-plot.png", width=10, height=6)
knitr::include_graphics("figures/multilevel-obs-plot.png")
```
...
ggsave("figures/multilevel-rt-plot.png", width=10, height=6)
knitr::include_graphics("figures/multilevel-rt-plot.png")
```
...
labels <- c("Intercept", "public events", "schools", "self isolating", "social distancing", "lockdown")
p <- p + ggplot2::scale_y_discrete(labels=labels)

ggsave("figures/multilevel-effect-plots.png", width=5, height=3)
knitr::include_graphics("figures/multilevel-effect-plots.png")
```
...
ggsave("figures/multilevel-total-effect-plots.png", width=5, height=3)
knitr::include_graphics("figures/multilevel-total-effect-plots.png")
```
...
in Sweden is quite possible an artefact of this. Nonetheless, the use of 
...
ggsave("figures/multilevel-interval-plots.png", plot=p, width=10, height=5)
knitr::include_graphics("figures/multilevel-interval-plots.png")
```
...
can also pass as an argument to `posterior_rt()`, `posterior_obs()` etc. 
...
ggsave("figures/multilevel-forecasting.png", plot=p, width = 10, height = 5)
knitr::include_graphics("figures/multilevel-forecasting.png")
```
...
ggsave("figures/multilevel-counterfactual.png", plot=p, width = 10, height = 5)
knitr::include_graphics("figures/multilevel-counterfactual.png")
```
