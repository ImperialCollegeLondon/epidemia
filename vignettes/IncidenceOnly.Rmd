...
## SARS 2003 - cumulative cases

We use the SARS data from 2003 as an example. Fitting to cumulative cases.
Currently independence between the cumulative counts is being assumed in the model - which probably should be relaxed.
