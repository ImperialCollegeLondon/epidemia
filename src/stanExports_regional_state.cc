...
#include "stanExports_regional_state.h"

RCPP_MODULE(stan_fit4regional_state_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_regional_state")
