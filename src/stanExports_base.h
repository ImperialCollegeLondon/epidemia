...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(582, 11, "end", "/data/data_model.stan");
    reader.add_event(582, 15, "restart", "model_base");
    reader.add_event(584, 17, "include", "/data/NKX.stan");
    reader.add_event(584, 0, "start", "/data/NKX.stan");
    reader.add_event(593, 9, "end", "/data/NKX.stan");
    reader.add_event(593, 18, "restart", "model_base");
    reader.add_event(593, 18, "include", "/data/data_glm.stan");
    reader.add_event(593, 0, "start", "/data/data_glm.stan");
    reader.add_event(606, 13, "end", "/data/data_glm.stan");
    reader.add_event(606, 19, "restart", "model_base");
    reader.add_event(606, 19, "include", "/data/hyperparameters.stan");
    reader.add_event(606, 0, "start", "/data/hyperparameters.stan");
    reader.add_event(620, 14, "end", "/data/hyperparameters.stan");
    reader.add_event(620, 20, "restart", "model_base");
    reader.add_event(620, 20, "include", "/data/glmer_stuff.stan");
    reader.add_event(620, 0, "start", "/data/glmer_stuff.stan");
    reader.add_event(635, 15, "end", "/data/glmer_stuff.stan");
    reader.add_event(635, 21, "restart", "model_base");
    reader.add_event(635, 21, "include", "/data/glmer_stuff2.stan");
    reader.add_event(635, 0, "start", "/data/glmer_stuff2.stan");
    reader.add_event(640, 5, "end", "/data/glmer_stuff2.stan");
    reader.add_event(640, 22, "restart", "model_base");
    reader.add_event(640, 22, "include", "/data/data_ac.stan");
    reader.add_event(640, 0, "start", "/data/data_ac.stan");
    reader.add_event(648, 8, "end", "/data/data_ac.stan");
    reader.add_event(648, 23, "restart", "model_base");
    reader.add_event(654, 29, "include", "/tdata/tdata_reverse.stan");
    reader.add_event(654, 0, "start", "/tdata/tdata_reverse.stan");
    reader.add_event(658, 4, "end", "/tdata/tdata_reverse.stan");
    reader.add_event(658, 30, "restart", "model_base");
    reader.add_event(658, 30, "include", "/tdata/tdata_glm.stan");
    reader.add_event(658, 0, "start", "/tdata/tdata_glm.stan");
    reader.add_event(678, 20, "end", "/tdata/tdata_glm.stan");
    reader.add_event(678, 31, "restart", "model_base");
    reader.add_event(686, 39, "include", "/parameters/parameters_glm.stan");
    reader.add_event(686, 0, "start", "/parameters/parameters_glm.stan");
    reader.add_event(698, 12, "end", "/parameters/parameters_glm.stan");
    reader.add_event(698, 40, "restart", "model_base");
    reader.add_event(698, 40, "include", "/parameters/parameters_ac.stan");
    reader.add_event(698, 0, "start", "/parameters/parameters_ac.stan");
    reader.add_event(700, 2, "end", "/parameters/parameters_ac.stan");
    reader.add_event(700, 41, "restart", "model_base");
    reader.add_event(715, 56, "include", "/tparameters/infections_rt.stan");
    reader.add_event(715, 0, "start", "/tparameters/infections_rt.stan");
    reader.add_event(718, 3, "end", "/tparameters/infections_rt.stan");
    reader.add_event(718, 57, "restart", "model_base");
    reader.add_event(718, 57, "include", "/tparameters/tparameters_ac.stan");
    reader.add_event(718, 0, "start", "/tparameters/tparameters_ac.stan");
    reader.add_event(721, 3, "end", "/tparameters/tparameters_ac.stan");
    reader.add_event(721, 58, "restart", "model_base");
    reader.add_event(721, 58, "include", "/tparameters/tparameters_glm.stan");
    reader.add_event(721, 0, "start", "/tparameters/tparameters_glm.stan");
    reader.add_event(755, 34, "end", "/tparameters/tparameters_glm.stan");
    reader.add_event(755, 59, "restart", "model_base");
    reader.add_event(764, 68, "include", "/tparameters/make_eta.stan");
    reader.add_event(764, 0, "start", "/tparameters/make_eta.stan");
    reader.add_event(788, 24, "include", "/tparameters/eta_add_Zb.stan");
    reader.add_event(788, 0, "start", "/tparameters/eta_add_Zb.stan");
    reader.add_event(790, 2, "end", "/tparameters/eta_add_Zb.stan");
    reader.add_event(790, 25, "restart", "/tparameters/make_eta.stan");
    reader.add_event(795, 30, "include", "/tparameters/eta_no_intercept.stan");
    reader.add_event(795, 0, "start", "/tparameters/eta_no_intercept.stan");
    reader.add_event(797, 2, "end", "/tparameters/eta_no_intercept.stan");
    reader.add_event(797, 31, "restart", "/tparameters/make_eta.stan");
    reader.add_event(800, 34, "include", "/tparameters/eta_add_ac.stan");
    reader.add_event(800, 0, "start", "/tparameters/eta_add_ac.stan");
    reader.add_event(801, 1, "end", "/tparameters/eta_add_ac.stan");
    reader.add_event(801, 35, "restart", "/tparameters/make_eta.stan");
    reader.add_event(804, 38, "end", "/tparameters/make_eta.stan");
    reader.add_event(804, 69, "restart", "model_base");
    reader.add_event(804, 69, "include", "/tparameters/gen_infections.stan");
    reader.add_event(804, 0, "start", "/tparameters/gen_infections.stan");
    reader.add_event(830, 26, "end", "/tparameters/gen_infections.stan");
    reader.add_event(830, 70, "restart", "model_base");
    reader.add_event(853, 93, "include", "/model/priors_glm.stan");
    reader.add_event(853, 0, "start", "/model/priors_glm.stan");
    reader.add_event(905, 52, "end", "/model/priors_glm.stan");
    reader.add_event(905, 94, "restart", "model_base");
    reader.add_event(905, 94, "include", "/model/priors_ac.stan");
    reader.add_event(905, 0, "start", "/model/priors_ac.stan");
    reader.add_event(914, 9, "end", "/model/priors_ac.stan");
    reader.add_event(914, 95, "restart", "model_base");
    reader.add_event(933, 112, "end", "model_base");
    return reader;
}
...
public:
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        try {
            ...
            for (size_t i_0__ = 0; i_0__ < ac_v_i_0_max__; ++i_0__) {
                check_greater_or_equal(function__, "ac_v[i_0__]", ac_v[i_0__], 0);
            ...
            for (size_t i_0__ = 0; i_0__ < ac_V_i_0_max__; ++i_0__) {
                for (size_t i_1__ = 0; i_1__ < ac_V_i_1_max__; ++i_1__) {
                    check_greater_or_equal(function__, "ac_V[i_0__][i_1__]", ac_V[i_0__][i_1__], 1);
                }
            }
            current_statement_begin__ = 656;
            ...
            validate_non_negative_index("z_phi", "R", R);
            num_params_r__ += R;
            current_statement_begin__ = 702;
            validate_non_negative_index("y_raw", "M", M);
            num_params_r__ += M;
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        try {
            writer__.vector_lb_unconstrain((logical_eq(prior_dist, 8) ? stan::math::promote_scalar<double>(0) : stan::math::promote_scalar<double>(stan::math::negative_infinity()) ), z_beta);
        } catch (const std::exception& e) {
        ...
        if (!(context__.contains_r("z_phi")))
            stan::lang::rethrow_located(std::runtime_error(std::string("Variable z_phi missing")), current_statement_begin__, prog_reader__());
        vals_r__ = context__.vals_r("z_phi");
        pos__ = 0U;
        validate_non_negative_index("z_phi", "R", R);
        context__.validate_dims("parameter initialization", "z_phi", "vector_d", context__.to_vec(R));
        Eigen::Matrix<double, Eigen::Dynamic, 1> z_phi(R);
        size_t z_phi_j_1_max__ = R;
        for (size_t j_1__ = 0; j_1__ < z_phi_j_1_max__; ++j_1__) {
            z_phi(j_1__) = vals_r__[pos__++];
        }
        try {
            writer__.vector_unconstrain(z_phi);
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(std::runtime_error(std::string("Error transforming variable z_phi: ") + e.what()), current_statement_begin__, prog_reader__());
        }
        current_statement_begin__ = 702;
        if (!(context__.contains_r("y_raw")))
            stan::lang::rethrow_located(std::runtime_error(std::string("Variable y_raw missing")), current_statement_begin__, prog_reader__());
        vals_r__ = context__.vals_r("y_raw");
        pos__ = 0U;
        validate_non_negative_index("y_raw", "M", M);
        context__.validate_dims("parameter initialization", "y_raw", "vector_d", context__.to_vec(M));
        Eigen::Matrix<double, Eigen::Dynamic, 1> y_raw(M);
        size_t y_raw_j_1_max__ = M;
        for (size_t j_1__ = 0; j_1__ < y_raw_j_1_max__; ++j_1__) {
            y_raw(j_1__) = vals_r__[pos__++];
        }
        try {
            writer__.vector_lb_unconstrain(0, y_raw);
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(std::runtime_error(std::string("Error transforming variable y_raw: ") + e.what()), current_statement_begin__, prog_reader__());
        }
        current_statement_begin__ = 703;
        ...
        pos__ = 0U;
        context__.validate_dims("parameter initialization", "tau_raw", "double", context__.to_vec());
        double tau_raw(0);
        tau_raw = vals_r__[pos__++];
        try {
            writer__.scalar_lb_unconstrain(0, tau_raw);
        } catch (const std::exception& e) {
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            if (jacobian__)
                z_beta = in__.vector_lb_constrain((logical_eq(prior_dist, 8) ? stan::math::promote_scalar<double>(0) : stan::math::promote_scalar<double>(stan::math::negative_infinity()) ), (logical_eq(prior_dist, 7) ? sum(num_normals) : K ), lp__);
            else
                z_beta = in__.vector_lb_constrain((logical_eq(prior_dist, 8) ? stan::math::promote_scalar<double>(0) : stan::math::promote_scalar<double>(stan::math::negative_infinity()) ), (logical_eq(prior_dist, 7) ? sum(num_normals) : K ));
            current_statement_begin__ = 688;
            ...
            current_statement_begin__ = 701;
            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> z_phi;
            (void) z_phi;  // dummy to suppress unused var warning
            if (jacobian__)
                z_phi = in__.vector_constrain(R, lp__);
            else
                z_phi = in__.vector_constrain(R);
            current_statement_begin__ = 702;
            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> y_raw;
            (void) y_raw;  // dummy to suppress unused var warning
            if (jacobian__)
                y_raw = in__.vector_lb_constrain(0, M, lp__);
            else
                y_raw = in__.vector_lb_constrain(0, M);
            current_statement_begin__ = 703;
            local_scalar_t__ tau_raw;
            (void) tau_raw;  // dummy to suppress unused var warning
            if (jacobian__)
                tau_raw = in__.scalar_lb_constrain(0, lp__);
            else
                tau_raw = in__.scalar_lb_constrain(0);
            current_statement_begin__ = 704;
            ...
            stan::math::assign(tau2,(prior_scale_for_tau * tau_raw));
            current_statement_begin__ = 711;
            validate_non_negative_index("y", "M", M);
            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> y(M);
            stan::math::initialize(y, DUMMY_VAR__);
            stan::math::fill(y, DUMMY_VAR__);
            stan::math::assign(y,multiply(tau2, y_raw));
            current_statement_begin__ = 714;
            validate_non_negative_index("phi", "R", R);
            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> phi(R);
            stan::math::initialize(phi, DUMMY_VAR__);
            stan::math::fill(phi, DUMMY_VAR__);
            stan::math::assign(phi,stan::math::fabs(add(elt_multiply(z_phi, prior_scale_for_phi), prior_mean_for_phi)));
            ...
            if (as_bool(logical_gt(ac_nterms, 0))) {
                ...
                for (int i = 1; i <= ac_nterms; ++i) {
                    current_statement_begin__ = 801;
                    stan::math::assign(eta, add(eta, stan::model::rvalue(ac_beta, stan::model::cons_list(stan::model::index_multi(get_base1(ac_V, i, "ac_V", 1)), stan::model::nil_index_list()), "ac_beta")));
                }
            }
            {
            ...
            lp_accum__.add(exponential_log(tau_raw, 1));
            current_statement_begin__ = 848;
            lp_accum__.add(exponential_log(y_raw, 1));
            current_statement_begin__ = 849;
            lp_accum__.add(normal_log(z_phi, 0, 1));
            ...
            if (as_bool(logical_eq(prior_dist, 1))) {
                ...
                lp_accum__.add(gamma_log(z_beta, prior_shape, elt_divide(1.0, prior_scale)));
            }
            ...
            if (as_bool(logical_eq(prior_PD, 0))) {
                ...
                lp_accum__.add(neg_binomial_2_log<propto__>(obs, add(E_obs, 1e-15), stan::model::rvalue(phi, stan::model::cons_list(stan::model::index_multi(obs_type), stan::model::nil_index_list()), "phi")));
            }
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
            // Next line prevents compiler griping about no return
    ...
    void write_array(RNG& base_rng__,
        ...
        Eigen::Matrix<double, Eigen::Dynamic, 1> z_beta = in__.vector_lb_constrain((logical_eq(prior_dist, 8) ? stan::math::promote_scalar<double>(0) : stan::math::promote_scalar<double>(stan::math::negative_infinity()) ), (logical_eq(prior_dist, 7) ? sum(num_normals) : K ));
        size_t z_beta_j_1_max__ = (logical_eq(prior_dist, 7) ? sum(num_normals) : K );
        for (size_t j_1__ = 0; j_1__ < z_beta_j_1_max__; ++j_1__) {
        ...
        Eigen::Matrix<double, Eigen::Dynamic, 1> z_phi = in__.vector_constrain(R);
        size_t z_phi_j_1_max__ = R;
        for (size_t j_1__ = 0; j_1__ < z_phi_j_1_max__; ++j_1__) {
            vars__.push_back(z_phi(j_1__));
        }
        Eigen::Matrix<double, Eigen::Dynamic, 1> y_raw = in__.vector_lb_constrain(0, M);
        size_t y_raw_j_1_max__ = M;
        for (size_t j_1__ = 0; j_1__ < y_raw_j_1_max__; ++j_1__) {
            vars__.push_back(y_raw(j_1__));
        }
        double tau_raw = in__.scalar_lb_constrain(0);
        vars__.push_back(tau_raw);
        ...
        try {
            ...
            current_statement_begin__ = 714;
            validate_non_negative_index("phi", "R", R);
            Eigen::Matrix<double, Eigen::Dynamic, 1> phi(R);
            stan::math::initialize(phi, DUMMY_VAR__);
            stan::math::fill(phi, DUMMY_VAR__);
            stan::math::assign(phi,stan::math::fabs(add(elt_multiply(z_phi, prior_scale_for_phi), prior_mean_for_phi)));
            current_statement_begin__ = 716;
    ...
    void constrained_param_names(std::vector<std::string>& param_names__,
        ...
        for (size_t j_1__ = 0; j_1__ < z_phi_j_1_max__; ++j_1__) {
            param_name_stream__.str(std::string());
            param_name_stream__ << "z_phi" << '.' << j_1__ + 1;
            param_names__.push_back(param_name_stream__.str());
        }
        size_t y_raw_j_1_max__ = M;
        for (size_t j_1__ = 0; j_1__ < y_raw_j_1_max__; ++j_1__) {
            param_name_stream__.str(std::string());
            param_name_stream__ << "y_raw" << '.' << j_1__ + 1;
            param_names__.push_back(param_name_stream__.str());
        }
        param_name_stream__.str(std::string());
        param_name_stream__ << "tau_raw";
        param_names__.push_back(param_name_stream__.str());
        size_t noise_j_2_max__ = R;
        size_t noise_j_1_max__ = M;
        for (size_t j_2__ = 0; j_2__ < noise_j_2_max__; ++j_2__) {
