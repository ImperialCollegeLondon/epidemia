...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(777, 109, "include", "/model/eta_add_Zb.stan");
    reader.add_event(777, 0, "start", "/model/eta_add_Zb.stan");
    reader.add_event(779, 2, "end", "/model/eta_add_Zb.stan");
    reader.add_event(779, 110, "restart", "model_base");
    reader.add_event(784, 115, "include", "/model/eta_no_intercept.stan");
