...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(584, 13, "end", "/data/data_model.stan");
    reader.add_event(584, 15, "restart", "model_base");
    reader.add_event(586, 17, "include", "/data/NKX.stan");
    reader.add_event(586, 0, "start", "/data/NKX.stan");
    reader.add_event(595, 9, "end", "/data/NKX.stan");
    reader.add_event(595, 18, "restart", "model_base");
    reader.add_event(595, 18, "include", "/data/data_glm.stan");
    reader.add_event(595, 0, "start", "/data/data_glm.stan");
    reader.add_event(608, 13, "end", "/data/data_glm.stan");
    reader.add_event(608, 19, "restart", "model_base");
    reader.add_event(608, 19, "include", "/data/hyperparameters.stan");
    reader.add_event(608, 0, "start", "/data/hyperparameters.stan");
    reader.add_event(622, 14, "end", "/data/hyperparameters.stan");
    reader.add_event(622, 20, "restart", "model_base");
    reader.add_event(622, 20, "include", "/data/glmer_stuff.stan");
    reader.add_event(622, 0, "start", "/data/glmer_stuff.stan");
    reader.add_event(637, 15, "end", "/data/glmer_stuff.stan");
    reader.add_event(637, 21, "restart", "model_base");
    reader.add_event(637, 21, "include", "/data/glmer_stuff2.stan");
    reader.add_event(637, 0, "start", "/data/glmer_stuff2.stan");
    reader.add_event(642, 5, "end", "/data/glmer_stuff2.stan");
    reader.add_event(642, 22, "restart", "model_base");
    reader.add_event(647, 27, "include", "/tdata/tdata_reverse.stan");
    reader.add_event(647, 0, "start", "/tdata/tdata_reverse.stan");
    reader.add_event(651, 4, "end", "/tdata/tdata_reverse.stan");
    reader.add_event(651, 28, "restart", "model_base");
    reader.add_event(651, 28, "include", "/tdata/tdata_glm.stan");
    reader.add_event(651, 0, "start", "/tdata/tdata_glm.stan");
    reader.add_event(671, 20, "end", "/tdata/tdata_glm.stan");
    reader.add_event(671, 29, "restart", "model_base");
    reader.add_event(678, 36, "include", "/parameters/parameters_glm.stan");
    reader.add_event(678, 0, "start", "/parameters/parameters_glm.stan");
    reader.add_event(690, 12, "end", "/parameters/parameters_glm.stan");
    reader.add_event(690, 37, "restart", "model_base");
    reader.add_event(705, 52, "include", "/tparameters/infections_rt.stan");
    reader.add_event(705, 0, "start", "/tparameters/infections_rt.stan");
    reader.add_event(708, 3, "end", "/tparameters/infections_rt.stan");
    reader.add_event(708, 53, "restart", "model_base");
    reader.add_event(708, 53, "include", "/tparameters/tparameters_glm.stan");
    reader.add_event(708, 0, "start", "/tparameters/tparameters_glm.stan");
    reader.add_event(742, 34, "end", "/tparameters/tparameters_glm.stan");
    reader.add_event(742, 54, "restart", "model_base");
    reader.add_event(742, 54, "include", "/tparameters/make_eta.stan");
    reader.add_event(742, 0, "start", "/tparameters/make_eta.stan");
    reader.add_event(766, 24, "include", "/tparameters/eta_add_Zb.stan");
    reader.add_event(766, 0, "start", "/tparameters/eta_add_Zb.stan");
    reader.add_event(768, 2, "end", "/tparameters/eta_add_Zb.stan");
    reader.add_event(768, 25, "restart", "/tparameters/make_eta.stan");
    reader.add_event(773, 30, "include", "/tparameters/eta_no_intercept.stan");
    reader.add_event(773, 0, "start", "/tparameters/eta_no_intercept.stan");
    reader.add_event(775, 2, "end", "/tparameters/eta_no_intercept.stan");
    reader.add_event(775, 31, "restart", "/tparameters/make_eta.stan");
    reader.add_event(778, 34, "end", "/tparameters/make_eta.stan");
    reader.add_event(778, 55, "restart", "model_base");
    reader.add_event(778, 55, "include", "/tparameters/gen_infections.stan");
    reader.add_event(778, 0, "start", "/tparameters/gen_infections.stan");
    reader.add_event(804, 26, "end", "/tparameters/gen_infections.stan");
    reader.add_event(804, 56, "restart", "model_base");
    reader.add_event(831, 83, "include", "/model/priors_glm.stan");
    reader.add_event(831, 0, "start", "/model/priors_glm.stan");
    reader.add_event(883, 52, "end", "/model/priors_glm.stan");
    reader.add_event(883, 84, "restart", "model_base");
    reader.add_event(903, 102, "end", "model_base");
    return reader;
}
...
public:
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        try {
            ...
            validate_non_negative_index("prior_mean_for_mu", "M", M);
            context__.validate_dims("data initialization", "prior_mean_for_mu", "vector_d", context__.to_vec(M));
            prior_mean_for_mu = Eigen::Matrix<double, Eigen::Dynamic, 1>(M);
            vals_r__ = context__.vals_r("prior_mean_for_mu");
            pos__ = 0;
            size_t prior_mean_for_mu_j_1_max__ = M;
            for (size_t j_1__ = 0; j_1__ < prior_mean_for_mu_j_1_max__; ++j_1__) {
                prior_mean_for_mu(j_1__) = vals_r__[pos__++];
            }
            current_statement_begin__ = 577;
            validate_non_negative_index("prior_scale_for_mu", "M", M);
            context__.validate_dims("data initialization", "prior_scale_for_mu", "vector_d", context__.to_vec(M));
            prior_scale_for_mu = Eigen::Matrix<double, Eigen::Dynamic, 1>(M);
            vals_r__ = context__.vals_r("prior_scale_for_mu");
            pos__ = 0;
            size_t prior_scale_for_mu_j_1_max__ = M;
            for (size_t j_1__ = 0; j_1__ < prior_scale_for_mu_j_1_max__; ++j_1__) {
                prior_scale_for_mu(j_1__) = vals_r__[pos__++];
            }
            ...
            validate_non_negative_index("z_mu", "M", M);
            num_params_r__ += M;
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        if (!(context__.contains_r("z_mu")))
            stan::lang::rethrow_located(std::runtime_error(std::string("Variable z_mu missing")), current_statement_begin__, prog_reader__());
        vals_r__ = context__.vals_r("z_mu");
        pos__ = 0U;
        validate_non_negative_index("z_mu", "M", M);
        context__.validate_dims("parameter initialization", "z_mu", "vector_d", context__.to_vec(M));
        Eigen::Matrix<double, Eigen::Dynamic, 1> z_mu(M);
        size_t z_mu_j_1_max__ = M;
        for (size_t j_1__ = 0; j_1__ < z_mu_j_1_max__; ++j_1__) {
            z_mu(j_1__) = vals_r__[pos__++];
        }
        try {
            writer__.vector_unconstrain(z_mu);
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(std::runtime_error(std::string("Error transforming variable z_mu: ") + e.what()), current_statement_begin__, prog_reader__());
        }
        current_statement_begin__ = 692;
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            current_statement_begin__ = 691;
            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> z_mu;
            (void) z_mu;  // dummy to suppress unused var warning
            if (jacobian__)
                z_mu = in__.vector_constrain(M, lp__);
            else
                z_mu = in__.vector_constrain(M);
            current_statement_begin__ = 692;
            ...
            stan::math::initialize(mu, DUMMY_VAR__);
            stan::math::fill(mu, DUMMY_VAR__);
            stan::math::assign(mu,stan::math::fabs(add(elt_multiply(z_mu, prior_scale_for_mu), prior_mean_for_mu)));
            ...
            lp_accum__.add(normal_log(z_mu, 0, 1));
    ...
    void write_array(RNG& base_rng__,
        ...
        Eigen::Matrix<double, Eigen::Dynamic, 1> z_mu = in__.vector_constrain(M);
        size_t z_mu_j_1_max__ = M;
        for (size_t j_1__ = 0; j_1__ < z_mu_j_1_max__; ++j_1__) {
            vars__.push_back(z_mu(j_1__));
        }
    ...
    void constrained_param_names(std::vector<std::string>& param_names__,
        ...
        for (size_t j_1__ = 0; j_1__ < z_mu_j_1_max__; ++j_1__) {
            param_name_stream__.str(std::string());
            param_name_stream__ << "z_mu" << '.' << j_1__ + 1;
            param_names__.push_back(param_name_stream__.str());
        }
        size_t z_phi_j_1_max__ = R;
        for (size_t j_1__ = 0; j_1__ < z_phi_j_1_max__; ++j_1__) {
