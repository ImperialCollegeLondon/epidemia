...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(36, 36, "include", "/functions/common_functions.stan");
    reader.add_event(36, 0, "start", "/functions/common_functions.stan");
    reader.add_event(335, 299, "end", "/functions/common_functions.stan");
    reader.add_event(335, 37, "restart", "model_base");
    reader.add_event(335, 37, "include", "/functions/continuous_likelihoods.stan");
    reader.add_event(335, 0, "start", "/functions/continuous_likelihoods.stan");
    reader.add_event(571, 236, "end", "/functions/continuous_likelihoods.stan");
    reader.add_event(571, 38, "restart", "model_base");
    reader.add_event(588, 55, "include", "/data/NKX.stan");
    reader.add_event(588, 0, "start", "/data/NKX.stan");
    reader.add_event(604, 16, "end", "/data/NKX.stan");
    reader.add_event(604, 56, "restart", "model_base");
    reader.add_event(604, 56, "include", "/data/data_glm.stan");
    reader.add_event(604, 0, "start", "/data/data_glm.stan");
    reader.add_event(621, 17, "end", "/data/data_glm.stan");
    reader.add_event(621, 57, "restart", "model_base");
    reader.add_event(621, 57, "include", "/data/weights_offset.stan");
    reader.add_event(621, 0, "start", "/data/weights_offset.stan");
    reader.add_event(628, 7, "end", "/data/weights_offset.stan");
    reader.add_event(628, 58, "restart", "model_base");
    reader.add_event(628, 58, "include", "/data/hyperparameters.stan");
    reader.add_event(628, 0, "start", "/data/hyperparameters.stan");
    reader.add_event(643, 15, "end", "/data/hyperparameters.stan");
    reader.add_event(643, 59, "restart", "model_base");
    reader.add_event(643, 59, "include", "/data/glmer_stuff.stan");
    reader.add_event(643, 0, "start", "/data/glmer_stuff.stan");
    reader.add_event(658, 15, "end", "/data/glmer_stuff.stan");
    reader.add_event(658, 60, "restart", "model_base");
    reader.add_event(658, 60, "include", "/data/glmer_stuff2.stan");
    reader.add_event(658, 0, "start", "/data/glmer_stuff2.stan");
    reader.add_event(663, 5, "end", "/data/glmer_stuff2.stan");
    reader.add_event(663, 61, "restart", "model_base");
    reader.add_event(670, 68, "include", "/tdata/tdata_glm.stan");
    reader.add_event(670, 0, "start", "/tdata/tdata_glm.stan");
    reader.add_event(690, 20, "end", "/tdata/tdata_glm.stan");
    reader.add_event(690, 69, "restart", "model_base");
    reader.add_event(703, 82, "include", "/parameters/parameters_glm.stan");
    reader.add_event(703, 0, "start", "/parameters/parameters_glm.stan");
    reader.add_event(714, 11, "end", "/parameters/parameters_glm.stan");
    reader.add_event(714, 83, "restart", "model_base");
    reader.add_event(736, 105, "include", "/tparameters/tparameters_glm.stan");
    reader.add_event(736, 0, "start", "/tparameters/tparameters_glm.stan");
    reader.add_event(769, 33, "end", "/tparameters/tparameters_glm.stan");
    reader.add_event(769, 106, "restart", "model_base");
    reader.add_event(769, 106, "include", "/model/make_eta.stan");
    reader.add_event(769, 0, "start", "/model/make_eta.stan");
    reader.add_event(775, 6, "end", "/model/make_eta.stan");
    reader.add_event(775, 107, "restart", "model_base");
    reader.add_event(803, 135, "include", "/model/eta_add_Zb.stan");
    reader.add_event(803, 0, "start", "/model/eta_add_Zb.stan");
    reader.add_event(805, 2, "end", "/model/eta_add_Zb.stan");
    reader.add_event(805, 136, "restart", "model_base");
    reader.add_event(810, 141, "include", "/model/eta_no_intercept.stan");
    reader.add_event(810, 0, "start", "/model/eta_no_intercept.stan");
    reader.add_event(812, 2, "end", "/model/eta_no_intercept.stan");
    reader.add_event(812, 142, "restart", "model_base");
    reader.add_event(863, 193, "include", "/model/priors_glm.stan");
    reader.add_event(863, 0, "start", "/model/priors_glm.stan");
    reader.add_event(912, 49, "end", "/model/priors_glm.stan");
    reader.add_event(912, 194, "restart", "model_base");
    reader.add_event(925, 205, "end", "model_base");
    return reader;
}
...
r0(const std::vector<int>& NC,
    ...
    try {
        ...
        for (int m = 2; m <= M; ++m) {
            ...
            stan::model::assign(vec, 
                        stan::model::cons_list(stan::model::index_min_max((get_base1(NC, (m - 1), "NC", 1) + 1), get_base1(NC, m, "NC", 1)), stan::model::nil_index_list()), 
                        rep_vector(get_base1(mu, m, "mu", 1), (get_base1(NC, m, "NC", 1) - get_base1(NC, (m - 1), "NC", 1))), 
                        "assigning variable vec");
        }
