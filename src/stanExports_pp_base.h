...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(36, 16, "restart", "model_pp_base");
    reader.add_event(50, 30, "include", "/tparameters/infections_rt.stan");
    reader.add_event(50, 0, "start", "/tparameters/infections_rt.stan");
    reader.add_event(53, 3, "end", "/tparameters/infections_rt.stan");
    reader.add_event(53, 31, "restart", "model_pp_base");
    reader.add_event(58, 36, "include", "/tparameters/gen_infections.stan");
    reader.add_event(58, 0, "start", "/tparameters/gen_infections.stan");
...
class model_pp_base
  : public stan::model::model_base_crtp<model_pp_base> {
private:
        int M;
        int N0;
