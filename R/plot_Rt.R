...
# # generic function
# plot_obs <- function(object, ...) UseMethod("plot_rt", object)

# # method
# plot_obs.epimodel <- function(object, type, levels = c(50,95)) {
  
#   if (length(type) > 1)
#     stop ("Can only plot one type of observation at a time.")
